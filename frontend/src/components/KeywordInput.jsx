...
const KeywordInput = ({ onGenerate, isLoading }) => {
  ...
  return (
    <motion.div
      ...
      className="fixed top-8 left-1/2 -translate-x-1/2 z-40 w-full max-w-2xl px-4"
    >
        ...
        <div className="glass-strong rounded-3xl p-2 shadow-neon-strong">
          <div className="flex items-center gap-3 px-4">
            ...
            <input
              ...
              className="flex-1 bg-transparent border-none outline-none text-white placeholder-gray-500 py-4 text-lg font-light"
              disabled={isLoading}
            />
            <motion.button
              type="submit"
              ...
              whileTap={{ scale: 0.95 }}
              className={`
                px-8 py-3 rounded-2xl font-heading font-semibold
